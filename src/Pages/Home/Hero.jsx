...
import {
  ...
  FaShieldAlt, FaAward, FaChevronLeft, FaChevronRight
} from 'react-icons/fa';
...
import heroimage2 from "../../assets/image06.jpeg";
import heroimage3 from "../../assets/image04.jpeg";

const Hero = () => {
  // Auto-scroll images array
  const heroImages = [
    { src: clinic, alt: "Physiotherapy Clinic - Professional Care" },
    { src: heroimage2, alt: "Physiotherapy Treatment Session" },
    { src: heroimage3, alt: "Expert Physiotherapy Care" }
  ];
  ...
  }, [isAutoScrolling, heroImages.length]);
      ...
      <section className="min-h-[500px] sm:min-h-[600px] bg-gradient-to-br from-slate-50 via-white to-teal-50/30 overflow-hidden relative">
        ...
        <div className="container mx-auto px-3 sm:px-4 py-6 sm:py-8 md:py-12 lg:py-16 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-6 sm:gap-8 md:gap-10 lg:gap-12">
            ...
            {/* Right Side - Auto-Scrolling Images - FIXED */}
            <motion.div
            ...
            >
              <div className="relative w-full max-w-2xl mx-auto lg:max-w-none">
                <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl border-4 border-white/50 bg-gray-100">
                  {/* Image Container with fixed aspect ratio - INCREASED HEIGHT */}
                    ...
                    <div className="absolute bottom-3 sm:bottom-4 left-1/2 transform -translate-x-1/2 flex gap-1.5 sm:gap-2 z-20">
                      {heroImages.map((_, index) => (
                        <button
                          ...
                          className={`transition-all duration-300 ${currentImageIndex === index
        ...
        <div className="container mx-auto px-3 sm:px-4 relative z-10">
          ...
          >
            {[
              ...
              { value: "13+ Years", label: "Expert Physiotherapist", icon: <FaUserMd className="text-teal-300 text-xs sm:text-sm" />, short: "Expert PT" }
            ].map((stat, index) => (
              <motion.div
                key={index}
                variants={itemVariants}
